...
public class Customize_layout_and_profile {
    ...
    {
        report = new ExtentReports("./Authentication_Test_Reports/Customize_profile_section_report.html");
        report.addSystemInfo("Smartstack","Authentication/access");
        report.addSystemInfo("performance","Customize profile page list Test Report");
